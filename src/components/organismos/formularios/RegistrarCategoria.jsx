...
import { InputText, Btnsave, ConvertirCapitalize,useCategoriaStore } from "../../../index";
    ...
    async function insertar(data){
        if(accion ==="Editar"){
            const p = {
                ...
                category_name: ConvertirCapitalize(data.category_name),
            ...
            onClose();
             ...
             const p = {
              _category_name: ConvertirCapitalize(data.category_name),
              _description: ConvertirCapitalize(data.description),
        };
